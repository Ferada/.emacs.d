...
hi Normal          ctermfg=grey  ctermbg=NONE gui=NONE guifg=#b7af9f guibg=#020202

" Search
hi IncSearch       ctermfg=NONE  ctermbg=NONE gui=NONE guifg=#000000 guibg=#e80048
hi Search          ctermfg=white ctermbg=blue gui=NONE guifg=#000000 guibg=#e80049
...
" Cursor
hi Cursor          ctermfg=NONE  ctermbg=NONE gui=NONE guifg=#090909 guibg=#80808F
...
" Fold
hi Folded          ctermfg=darkgrey  ctermbg=NONE gui=NONE guifg=#808080 guibg=#222232
hi FoldColumn      ctermfg=white  ctermbg=NONE gui=NONE guifg=#559f00 guibg=#0f0f0b

" Other
" the area below the text
hi NonText         ctermfg=darkgrey  ctermbg=NONE gui=NONE guifg=#b7af9f guibg=NONE
...
" Syntax group
hi Comment         ctermfg=darkgrey  ctermbg=NONE gui=NONE      guifg=#74748a guibg=NONE
hi Constant        ctermfg=darkblue  ctermbg=darkgrey gui=NONE      guifg=#acabc7 guibg=NONE
...
hi Statement       ctermfg=darkmagenta  ctermbg=NONE gui=NONE      guifg=#d1bfb1 guibg=NONE
hi Todo            ctermfg=red  ctermbg=grey gui=bold      guifg=#efe469 guibg=#515151
hi Type            ctermfg=white  ctermbg=NONE gui=NONE      guifg=#707099 guibg=NONE
