" Vim color file
" Maintainer:   Olof Frahm <Olof.Frahm@web.de>
...
hi Pmenu        guifg=bisque2 guibg=grey10
hi Normal       guifg=bisque2            guibg=grey5
hi Cursor       guifg=grey15              guibg=bisque3
...
hi SpecialComment   guifg=tan guibg=gray15
